...
export function LandingFooter() {
  return (
    <footer className="bg-paper py-14 md:py-20">
      <div className="mx-auto grid max-w-6xl gap-12 px-5 md:grid-cols-[1.6fr_1fr_1fr] md:gap-10">
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-ink/8 px-5 pt-6 text-[11px] text-ink-muted">
        © {new Date().getFullYear()} Squad
      </div>
    </footer>
  );
}
